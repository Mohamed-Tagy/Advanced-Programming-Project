...
class AppointmentPage:
    ...
    def update_status(self, index, new_status):
        self.appointments[index]["status"] = new_status
        self.page.update()

    def status_chip(self, status):
        color = {
    ...
    def build(self) -> ft.View:
        ...
        for i, ap in enumerate(self.appointments):
            ...
            if ap["status"] == "Pending":
                action_buttons = [
                    ft.IconButton(
                        ...
                        tooltip="Approve", 
                        on_click=lambda e, i=i: self.update_status(i, "Approved")
                    ),
                    ft.IconButton(
                        ft.Icons.CLOSE, 
                        icon_color=ft.Colors.RED,
                        tooltip="Reject", 
                        on_click=lambda e, i=i: self.update_status(i, "Rejected")
                    ),
                ]
            ...
            rows.append(ft.DataRow(
                cells=[
                    ...
                    ft.DataCell(self.status_chip(ap["status"])),
        ...
        # استخدام الكلاس AdminLayout بدل الدالة
        return ft.View(
            route="/appointments",
            padding=0,
